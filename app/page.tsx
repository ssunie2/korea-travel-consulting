              ...
              <div className="ktc-route-scene relative">
                ...
                <fieldset className="absolute inset-0 m-0 border-0 p-0">
                  ...
                  */}
                      ...
                      {/* 날짜 — 점 위 */}
                      <span className="absolute bottom-[calc(50%+12px)] left-1/2 -translate-x-1/2 whitespace-nowrap font-[family-name:var(--font-geist-mono)] text-[0.62rem] font-bold leading-none tracking-[0.16em] text-[var(--c-text)] group-has-[:checked]:text-[var(--c-accent)] sm:bottom-[calc(50%+15px)] sm:text-[0.8rem] sm:tracking-[0.2em] md:bottom-[calc(50%+21px)]">
                        DAY {station.day}
                      </span>
                      ...
                      <span className="absolute top-[calc(50%+12px)] left-1/2 -translate-x-1/2 whitespace-nowrap text-center font-[family-name:var(--font-geist-mono)] text-[0.5rem] leading-none tracking-[0.1em] text-[var(--c-text-3)] sm:top-[calc(50%+15px)] sm:text-[0.65rem] sm:tracking-[0.14em] md:top-[calc(50%+21px)]">
                        {station.en}
                      </span>
                      <span className="absolute top-[calc(50%+27px)] left-1/2 -translate-x-1/2 whitespace-nowrap text-center font-[family-name:var(--font-geist-mono)] text-[0.5rem] leading-none text-[var(--c-text-4)] sm:top-[calc(50%+34.4px)] sm:text-[0.6rem] md:top-[calc(50%+48.7px)]">
                        {station.ko}
                      </span>
                    </label>
                  ))}
            ...
            <div className="mt-10 grid gap-10 md:grid-cols-2 md:gap-16">
              ...
              <div>
                <p className="font-[family-name:var(--font-geist-mono)] text-xs uppercase tracking-[0.15em] text-[var(--c-accent)]">
                  ...
                  **랜딩에는 금액이 한 군데도 없다.** 손님이 값을 처음 보는 곳은
                  상담 신청 화면(`/plan/[id]/consult`) 하나뿐이다.
                  (전에는 "아래 '가격' 칸과 진행 방식 03 에 그대로 있다" 고 적혀 있었는데
                   두 곳 다 금액이 빠졌고 '가격' 칸은 '시작하기' 로 이름도 바뀌었다 — 이슈 #53 🟢)
                */}
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:items-center md:py-20">
            <div>
              ...
              */}
              ...
              (예전 가격 문구는 375px 폰에서 한 줄 자리를 넘겼다)
            ...
            */}
              ...
              {/*
              **값 줄을 뺀 뒤로 문단은 하나다** (아래 주석 참고). 그 하나가 두 도막이고,
              폰에서는 나뉘고 PC 에서는 이어 붙는다.
              max-w 를 PC 에서 넓히지 않으면 이어 붙여도 다시 접힌다.

              (전에는 여기에 "뒤의 두 도막만 이어 붙이고 폰은 셋 다 나뉜다" 고 적혀 있었다.
               값 줄이 빠지면서 도막이 셋에서 둘로 줄었는데 주석만 남아 있었다 — 이슈 #53 🟢.
               자식이 하나뿐이라 아무 일도 안 하던 space-y-1.5 도 같이 뺐다.)
            */}
              <div className="mt-4 max-w-md leading-relaxed text-[var(--c-text-2)] md:max-w-none">
                {/*
